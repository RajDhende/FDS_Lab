...
/**
 * A class implementing the all the function using a menu based interface
 */
public class Main {
    /**
     * Main method to run the graph application.
     *
        ...
        try {
            while (true) {
                try {
                    ...
                    System.out.println("9. Display Adjacency Map");
                    System.out.println("10. Remove Vertex");
                    System.out.println("11. Remove Edge");
                    ...
                    switch (choice) {
                        ...
                        case 10:
                            ...
                            if (vertexToRemove != null) {
                                ...
                                System.out.println("Vertex and incident edges removed successfully.");
                            } else {
                                System.out.println("Vertex not found.");
                            }
                            break;
                        ...
                        case 11:
                            // Remove Edge
                            System.out.print("Enter source vertex element of the edge to remove: ");
                            String sourceElementToRemove = scanner.next();
                            System.out.print("Enter target vertex element of the edge to remove: ");
                            ...
                            if (sourceVertexToRemove != null && targetVertexToRemove != null) {
    ...
    /**
     * Finds a vertex in the graph based on its element.
     *
